const translation = {
  ...
  welcome: 'Welcome to Xinchain, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Xinchain Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on Xinchain',
  invalid: 'The link has expired',
  explore: 'Explore Xinchain',
